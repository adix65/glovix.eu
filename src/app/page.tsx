      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 sm:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {[
            {
              icon: (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10 text-[#E31937]">
                  <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                </svg>
              ),
              title: "Ubezpieczenie do 1 mln €",
              desc: "Pełne ubezpieczenie ładunków do miliona euro — Twój pojazd jest bezpieczny na każdym etapie transportu.",
            },
            {
              icon: (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10 text-[#E31937]">
              ...
              title: "Dokument CMR",
              desc: "Do każdego zlecenia wystawiamy międzynarodowy list przewozowy CMR — pełna dokumentacja transportu.",
            },
            {
              icon: (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10 text-[#E31937]">
              ...
              title: "Zdjęcia załadunku i rozładunku",
              desc: "Dokumentujemy stan pojazdu przed załadunkiem i po rozładunku — pełna transparentność i bezpieczeństwo.",
            },
            {
              icon: (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10 text-[#E31937]">
              ...
              title: "Śledzenie GPS",
              desc: "Możliwość śledzenia transportu w czasie rzeczywistym — zawsze wiesz, gdzie jest Twój pojazd.",
            },
          ].map((item) => (
